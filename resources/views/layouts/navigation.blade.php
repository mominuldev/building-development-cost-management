                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3">
                        ...
                        <div class="hidden sm:block">
                            <span class="text-xl font-bold text-gray-900">Construction</span>
                            <span class="text-xl font-bold text-blue-600">Cost</span>
                            <span class="text-xl font-bold text-gray-900">Calculator</span>
                        </div>
                    </a>
                </div>
