            ...
            <div class="card bg-white shadow-xl">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mt-6">
                        ...
                        <!-- Add Contractor -->
                        <a href="{{ route('projects.contractors.create', $project) }}" class="group flex items-center gap-3 rounded-lg bg-gradient-to-r from-orange-600 to-orange-500 px-4 py-3 text-white shadow-lg shadow-orange-200 transition-all duration-300 hover:shadow-xl hover:shadow-orange-300 hover:-translate-y-0.5">
                            <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-white/20 backdrop-blur-sm">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card bg-white shadow-xl hover:shadow-2xl transition-shadow">
                    <div class="card-body">
                        ...
                        @endif
                        <div class="card-actions mt-4">
                            <a href="{{ route('projects.contractors.index', $project) }}" class="btn btn-success btn-sm flex-1">
