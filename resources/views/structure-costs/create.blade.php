    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold leading-tight text-gray-800">
                {{ __('Add Structure Cost - ') . $project->name }}
            </h2>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    <h3 class="card-title mb-4">Add New Structure Cost</h3>
                    ...
                    <form action="{{ route('projects.structure-costs.store', $project) }}" method="POST">
                        ...
                        <div class="card-actions justify-end mt-6">
                            ...
                            <button type="submit" class="btn btn-warning">Add Structure Cost</button>
                        </div>
                    </form>
                </div>
            </div>
