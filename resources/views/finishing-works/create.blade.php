<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Add Finishing Work</h2>
                <p class="text-gray-500 mt-1">{{ $project->name }}</p>
            </div>
            <a href="{{ route('projects.finishing-works.index', $project) }}" class="btn btn-ghost btn-sm gap-2">
            ...
            <div class="card bg-white shadow-xl">
                <div class="card-body">
                    <div class="flex items-center gap-3 mb-6">
                        <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900">New Finishing Work</h3>
                            <p class="text-sm text-gray-500">Record finishing work expenses (flooring, painting, fixtures, etc.)</p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('projects.finishing-works.store', $project) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="form-control">
                                <label class="label">
                                    <span class="label-text font-semibold text-gray-900">Work Type</span>
                                    <span class="label-text-alt text-error">*</span>
                                </label>
                                <div class="relative">
                                    <select name="work_type" class="select select-bordered w-full appearance-none" required>
                                ...
                                <label class="label">
                                    <span class="label-text-alt">Choose the type of finishing work</span>
                                </label>
                            </div>
                            ...
                            <div class="form-control">
                                ...
                                <label class="label">
                                    <span class="label-text-alt">Specific name for this finishing work</span>
                                </label>
                            </div>
                            ...
                            <div class="card bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200">
                                <div class="card-body p-4">
                                    <div class="flex items-center gap-3">
                                        <div class="h-10 w-10 rounded-lg bg-pink-500 flex items-center justify-center">
                        ...
                        <div class="flex justify-end gap-3 mt-8 pt-6 border-t">
                            <a href="{{ route('projects.finishing-works.index', $project) }}" class="btn btn-ghost gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
